...
// Переменная a в static_1 является static переменной, что означает что она доступна только в файле в котором объявлена.
// В static_2 переменная a глобальная, что означает что она может использоваться и другими файлами.
// Для того чтобы сделать переменную a в static_2 эквивалентоной переменной a в static_1 достаточно добавить модификатор static в к объявлению переменной
